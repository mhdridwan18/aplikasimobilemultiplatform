      ...
      return this.http.post(this.env.API_URL + 'register', data).pipe(
        ...
        logout() {
          ...
          const headers = new HttpHeaders({ 
            ...
            JSON.parse(localStorage.getItem('user')).token,'Accept': 'application/json'
          });
          //melakukan request dengan method post//dengan fungsi pipe untuk meneruskan data ke pemanggil fungsi ini
